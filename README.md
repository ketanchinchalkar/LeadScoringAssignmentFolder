...
Data Cleaning
Exploratory data analysis with univariate and multivariate analysis
Remove Outliers
Creating Dummy variables for the categorical variables
Split the data into train and test set 70:30
Build Model with multiple iterations by ensuring the pvalue is less than 0.05 and VIN is less than 5
Make Predictions on the Test set
Model Evaluation
Draw ROC Curve
Calculate Accuracy, precision and recall on train set
Make Predictions on test set
Calculate accuracy,Precision,Recall on test set

# Files present
Lead Scoring - Logistic Regression.ipynb : The python file with the code
Assignment Subjective Questions.pdf : Some subjective questions answered
Lead Score Case Study.pdf : Final Presentation
Leads.csv : Data worked on
Leads Data Dictionary.xlsx : Data Dictionary
Summary.pdf : Summary of the approach on the python file
